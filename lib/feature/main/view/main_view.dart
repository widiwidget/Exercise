  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ConvexAppBar(
        ...
        items: [
          _tabItem(Icons.flag_outlined,0,"Compus"),
          _tabItem(Icons.bolt_outlined,1,"Activity"),
          _tabItem(Icons.circle_outlined,2,"My Space"),
          _tabItem(Icons.groups_outlined,3,"Clubs"),
          _tabItem(Icons.layers_outlined,4,"Resource"),
        ],
        onTap: (index) {
          setState(() {
            activeIndex = index;
